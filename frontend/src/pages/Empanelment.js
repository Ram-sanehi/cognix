...
const Empanelment = () => {
  ...
  const testimonials = [
  {
    quote: "Cognix AI played a key role in modernizing our legacy systems with AI-powered solutions. Their structured approach and technical depth stood out.",
    author: "Rohit Malhotra",
    position: "Director of Engineering, IntegraSoft",
    company: "Enterprise Software Services",
    gradient: "from-blue-500 to-cyan-500"
  },
  {
    quote: "The team at Cognix AI understands both technology and business. Their AI implementations helped us improve decision-making and operational visibility.",
    author: "Neha Kulkarni",
    position: "Product & Innovation Lead, FinEdge Analytics",
    company: "Data & Analytics Company",
    gradient: "from-green-500 to-emerald-500"
  },
  {
    quote: "From planning to deployment, Cognix AI delivered with clarity and consistency. Their AI solutions scaled smoothly with our growing user base.",
    author: "Sandeep Iyer",
    position: "Head of Technology, CareSphere Digital",
